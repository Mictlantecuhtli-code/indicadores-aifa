...
export default function AppLayout() {
  ...
  const displayName = profile?.nombre_completo ?? profile?.nombre ?? accountEmail ?? 'Usuario';
              ...
              <div className="flex items-center gap-3">
                <div className="relative" ref={accountMenuRef}>
                  <button
                    ...
                    className="inline-flex items-center gap-3 rounded-full border border-aifa-blue/80 bg-white px-4 py-2 text-sm font-semibold text-aifa-blue transition hover:border-aifa-light hover:bg-aifa-light/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-aifa-light focus-visible:ring-offset-2"
                    aria-haspopup="menu"
                    aria-expanded={isAccountMenuOpen}
                  >
                    <span className="flex min-w-0 flex-col items-center text-center leading-tight">
                      <span className="max-w-[12rem] truncate text-[11px] font-semibold uppercase tracking-[0.35em] text-aifa-blue/80">
                        {displayRole}
                      </span>
                      <span className="max-w-[12rem] truncate text-sm font-semibold text-aifa-blue">{displayName}</span>
                      <span className="max-w-[12rem] truncate text-[11px] text-slate-500">{accountEmail}</span>
                    </span>
                    <ChevronDown

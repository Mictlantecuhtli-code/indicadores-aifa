          ...
          <div class="flex items-center gap-3">
            <div class="relative" id="account-menu-container">
              <button
                ...
                type="button"
                class="inline-flex items-center gap-3 rounded-full border border-aifa-blue/80 bg-white px-4 py-2 text-sm font-semibold text-aifa-blue transition hover:border-aifa-light hover:bg-aifa-light/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-aifa-light focus-visible:ring-offset-2"
                aria-haspopup="menu"
                aria-expanded="false"
              >
                <span class="flex min-w-0 flex-col items-center text-center leading-tight">
                  <span class="max-w-[12rem] truncate text-[11px] font-semibold uppercase tracking-[0.35em] text-aifa-blue/80">${accountRole || 'Cuenta'}</span>
                  <span class="max-w-[12rem] truncate text-sm font-semibold text-aifa-blue">${accountName || 'Usuario'}</span>
                  <span class="max-w-[12rem] truncate text-[11px] text-slate-500">${accountEmail || ''}</span>
                </span>
                <i class="fa-solid fa-chevron-down text-xs text-aifa-blue transition-transform" id="account-menu-chevron"></i>
              </button>
              <div
                id="account-menu"
              ...
              >
                <div class="border-b border-slate-100 bg-slate-50/60 px-4 py-3 text-sm text-slate-700">
                  <p class="font-semibold text-aifa-blue">${accountName || 'Usuario'}</p>
                  <p class="mt-1 text-xs font-semibold uppercase tracking-[0.35em] text-slate-500">${accountRole || '—'}</p>
                  <p class="mt-1 break-all text-xs text-slate-500">${accountEmail || ''}</p>
                </div>
                <div class="flex flex-col py-1 text-sm text-slate-600">
                  <button
                    type="button"
                    class="flex items-center gap-2 px-4 py-2 text-left transition hover:bg-aifa-light/10 hover:text-aifa-blue"
